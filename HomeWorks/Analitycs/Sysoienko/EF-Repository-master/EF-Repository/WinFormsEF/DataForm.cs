...
namespace WinFormsEF
{
    public partial class DataForm : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'combatDbDataSet.Pvps' table. You can move, or remove it, as needed.
            this.pvpsTableAdapter.Fill(this.combatDbDataSet.Pvps);
            // TODO: This line of code loads data into the 'combatDbDataSet.Pves' table. You can move, or remove it, as needed.
            this.pvesTableAdapter.Fill(this.combatDbDataSet.Pves);
